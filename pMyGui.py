...
class FindLocation(object):
    def __init__(self):
        ...
        self.display_info.column('5', width=70, anchor='ne')
        self.display_info.column('6', width=70, anchor='ne')
        self.display_info.column('7', width=70, anchor='ne')
        self.display_info.column('8', width=70, anchor='ne')
    ...
    def FuncInput(self):
        ...
        self.Root_xoffset = self.root.winfo_x()
        self.Root_yoffset = self.root.winfo_y()
        child_width = ((self.RootWidth - 280) / 2) + self.Root_xoffset
        child_height = ((self.RootHeight - 80) / 2) + self.Root_yoffset
        size_str = '280x80+%d+%d' % (child_width, child_height)
